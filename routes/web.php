...
Route::resource('userjurusan', \App\Http\Controllers\UserJurusanController::class);



Route::get('/', [\App\Http\Controllers\PesertaPelatihanController::class, 'create'])->name('pendaftaran.create');
